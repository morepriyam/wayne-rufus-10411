 ...
 *
 * These are manually authored (generated via Python trapezoidal profile) and
 * stored
 * here — NOT in ChoreoTraj.java — because ChoreoTraj.java is auto-regenerated
 * by the
 * Choreo Gradle plugin from ChoreoProject.chor and would overwrite manual
 * additions.
 *
